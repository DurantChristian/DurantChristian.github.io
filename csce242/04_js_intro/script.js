...
document.getElementById("donation-message").innerHTML = '$${GOAL - donation} to go'; 
// update thermometer
document.getElementById("thermometer").style.setProperty("--donationPercent", donationPercent + "%");
